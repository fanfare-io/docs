...
| --------------------- | ------------------------------------------------ | ------------- |
| **Consumer chooses**  | Consumers pick their product and variant         | Most launches |
| **Random assignment** | Fanfare assigns from the configured product pool | Mystery boxes |
