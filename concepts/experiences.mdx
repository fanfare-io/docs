...
│  │   Priority: 100  │  → Early access via lottery              │
│  │   Audience: VIP  │                                          │
│  └──────────────────┘                                          │
│           │                                                     │
...
1. The system checks sequences in priority order (higher numeric priority is evaluated first)
