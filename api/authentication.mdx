...
For integrating with your existing authentication system. See the [External Authentication](/guides/authentication/external-authentication) guide for the full contract, including identity consolidation via `canonicalSubject`:
