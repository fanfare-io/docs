...
Winner selection is separate from product allocation. If the experience uses system-assigned products, configure product weights in the product allocation step so Fanfare can assign from the product pool after a consumer is selected.
