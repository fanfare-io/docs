...
Winner selection is separate from product allocation. Selection methods decide which eligible consumers are selected as winners; product allocation decides what product a selected consumer receives.
