...
![Create experience](./images/create-experience-start.png)
...
![Basic information](./images/create-basic-info.png)
...
![Product selection](./images/create-product-select.png)
_Caption: Select a product from your catalog_
...
![Audience selection](./images/create-audience-select.png)
_Caption: Select which audience can access this experience_
...
![Schedule configuration](./images/create-schedule.png)
...
![Inventory settings](./images/create-inventory.png)
...
![Validation errors](./images/create-validation.png)
