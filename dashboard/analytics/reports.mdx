...
![Generate report](./images/reports-generate.png)
...
![Date range](./images/reports-date-range.png)
...
![Schedule report](./images/reports-schedule.png)
...
- [API Documentation](/api/reports) - Report API reference
