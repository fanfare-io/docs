...
![Consumer detail](./images/consumer-detail.png)
...
![RFM chart](./images/consumer-rfm-chart.png)
...
![Value card](./images/consumer-value-card.png)
...
![Sync sources](./images/consumer-sync-sources.png)
