...
![Activity timeline](./images/consumer-activity-timeline.png)
...
![Event detail](./images/consumer-event-detail.png)
...
![Timeline filter](./images/consumer-timeline-filter.png)
...
![Purchase event](./images/consumer-purchase-event.png)
