...
![Audiences list](./images/audiences-list.png)
...
![Audience options](./images/audiences-options.png)
...
![Audience actions](./images/audiences-actions.png)
...
![Audience group](./images/audiences-group.png)
...
![Create options](./images/audiences-create-dropdown.png)
...
![Audience detail](./images/audiences-detail.png)
_Caption: The audience detail page provides comprehensive management options_

## Using Audiences in Experiences

When creating or editing an experience, select which audiences can participate:

1. Navigate to the experience
2. Find the Audience selection field
3. Choose one or more audiences
4. Consumers in selected audiences can access the experience

### Multiple Audiences

When multiple audiences are selected:

- A consumer in **any** selected audience can participate
- This creates a union of all selected audiences
- Great for combining different customer segments
...
![Multiple audiences](./images/audiences-multiple-select.png)
_Caption: Select multiple audiences for combined access_
...
![Delete confirmation](./images/audiences-delete.png)
