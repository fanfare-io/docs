...
4. Consumers who match the configured audience rules can access that path

### Multiple Audiences

When multiple audiences are selected:

- Treat the selection as eligibility criteria for that access path
- Use experience sequences to define ordering when multiple paths are available
