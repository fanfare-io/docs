...
Type: screenshot
Page: /auth/sign-up
Shows: Sign-up form with email and password fields
Annotations: None needed
Alt text: "Fanfare sign-up form for creating a new account"
*/}

![Sign up form](./images/sign-up.png)
_Caption: Create your Fanfare account with email and password_
...
![Brand settings](./images/brand-settings.png)
...
![Create audience](./images/create-audience.png)
...
![Experience types](./images/experience-types.png)
...
![Create queue](./images/create-queue.png)
...
- [API Integration](/sdk/introduction) - Embed experiences in your site
