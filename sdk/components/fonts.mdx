...
```html
<fanfare-experience experience-id="exp_123" load-fonts></fanfare-experience>
```
...
The SDK will not fetch it. Self-host the font, declare it with your own `@font-face`, and set `fontFamily` (and `fontHeading`) to its family name so the widget's text uses it.
