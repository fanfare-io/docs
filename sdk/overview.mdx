...
| [Shopify storefront](/sdk/shopify/quickstart) | You run a Shopify theme, Hydrogen/Oxygen, or headless storefront and want to gate products and checkout. | `createShopifyExperienceResolver`, `createShopifyCheckoutVerifier`, `createShopifyCheckoutClaimer`, `FanfareAdapterProvider` |
