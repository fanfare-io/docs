...
If your organization has its own authentication system, you can clear the `authentication` gate without OTP by exchanging a code your backend requests on the user's behalf — see [External Authentication](/guides/authentication/external-authentication).
