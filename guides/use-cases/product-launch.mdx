...
export function ProductLaunchExperience({ queueId, product }: ProductLaunchExperienceProps) {
  ...
  const stage = view?.journeyStage === "routed" ? view.sequence.stage : (view?.journeyStage ?? "loading");
  ...
  return (
    <div className="launch-experience">
      ...
      {view?.journeyStage === "routed" && view.sequence.stage === "participating" && (
      ...
      {view?.journeyStage === "routed" && view.sequence.stage === "denied" && <CompletedState />}
    ...
    <div className="queue-state">
      ...
      <div className="queue-stats">
        <div className="stat position">
          ...
          <span className="value">{sequence.stage}</span>
        </div>
