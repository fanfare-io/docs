---
title: Appointment Booking Use Case
description: Manage appointment scheduling with fair access to limited time slots.
---
...
async function createAppointmentQueue(
  ...
  return (
    <div className="waiting-state">
      ...
      <p className="instructions">
        Please keep this page open. We'll notify you when it's your turn to
        book.
      </p>
    </div>
  );
      ...
      {selectedDate && selectedSlot && (
        <div className="booking-summary">
          ...
          >
            {isSubmitting
              ? "Reserving..."
              : `Book & Pay $${service.depositAmount || service.price}`}
          </button>
        </div>
      )}
    </div>
    ...
    <div className="booking-confirmed">
      ...
      <div className="confirmation-details">
        ...
        <dl>
          ...
          <dd>
            {service.location === "virtual"
              ? "Video Call (link will be emailed)"
              : booking?.address}
          </dd>
        </dl>
      </div>
...
export async function cancelAppointment(
  ...
  const appointment = await db.query.appointments.findFirst({
    where: and(
      ...
      eq(appointments.consumerId, consumerId),
    ),
  });
  ...
  const isFreeCancellation =
    hoursUntilAppointment >= service.freeCancellationHours;
  ...
  await db.transaction(async (tx) => {
    ...
    const nextInWaitlist = await tx
      ...
      .where(
        and(
          eq(appointmentWaitlist.slotId, appointment.slotId),
  ...
  if (isFreeCancellation && appointment.depositPaid) {
    ...
    await processPartialRefund(
      ...
      appointment.depositAmount - service.cancellationFee,
    );
  }
}
```
  ...
  return (
    <section className="booking-rules">
      ...
      <ul>
        ...
        <li>
          Maximum {service.maxBookingsPerConsumer} active bookings per customer
        </li>

        {service.requireDeposit && (
          <li>Deposit of ${service.depositAmount} required to confirm</li>
        )}

        <li>
          Free cancellation up to {service.freeCancellationHours} hours before
          appointment
        </li>

        {service.cancellationFee && (
          <li>Late cancellation fee: ${service.cancellationFee}</li>
        )}
      </ul>
    </section>
  );
