...
| ----------- | ------------ |
| Production  | Use the production base URL shown in the API reference or dashboard. |
| Test/Staging | Use the environment-specific base URL provided by Fanfare. |
| Development | Use the local service URL from your development setup. |
