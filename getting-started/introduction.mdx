...
![Journey mental model showing your app using the Fanfare SDK to read JourneyView state and valid actions.](/images/concepts/journey-mental-model.webp)
...
![Browser SDK fit showing a product page using the Fanfare SDK, Fanfare API, and backend checkout handoff.](/images/concepts/browser-sdk-fit.webp)
