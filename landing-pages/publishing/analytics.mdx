...
<CardGroup cols={2}>
  <Card title="Beacon Tracking" icon="broadcast-tower" href="/integrations/analytics/beacon">
  ...
  <Card title="Experience Metrics" icon="chart-bar" href="/dashboard/analytics/experience-metrics">
