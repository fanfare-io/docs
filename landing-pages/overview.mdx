...
| Full brand control needed              | [SDK Integration](/sdk/overview)                                        |
| Complex checkout flow                  | [SDK](/sdk/overview) or [Shopify App](/integrations/e-commerce/shopify) |
| Permanent storefront feature           | [SDK Integration](/sdk/overview)                                        |
...
For full control over the consumer experience, use the [Fanfare SDK](/sdk/overview) to embed widgets directly in your existing website or application.
