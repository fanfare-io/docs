...
| Full brand control needed              | [SDK Integration](/sdk/core/overview)                                        |
| Complex checkout flow                  | [SDK](/sdk/core/overview) or [Shopify App](/integrations/e-commerce/shopify) |
| Permanent storefront feature           | [SDK Integration](/sdk/core/overview)                                        |
...
For full control over the consumer experience, use the [Fanfare SDK](/sdk/core/overview) to embed widgets directly in your existing website or application.
...
<CardGroup cols={2}>
  ...
  <Card title="SDK Alternative" icon="code" href="/sdk/core/overview">
