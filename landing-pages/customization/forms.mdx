...
See [Webhooks](/api/webhooks/overview) for setup instructions.
...
<CardGroup cols={2}>
  ...
  <Card title="Authentication" icon="lock" href="/guides/authentication/identified-consumers">
    Configure authentication options
  </Card>
  <Card title="Access Codes" icon="ticket" href="/concepts/experiences">
    Set up VIP access
  </Card>
</CardGroup>
