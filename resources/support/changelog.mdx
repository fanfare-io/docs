...
- **Fingerprint Bypass**: Support for bypass tokens in scenarios where fingerprinting isn't possible
...
- **SolidJS SDK**: New `@fanfare/sdk-solid` package for SolidJS applications
...
- [Migrating from SDK v1 to v2](/docs/migration/sdk-v2)
- [API Version Migration](/docs/migration/api-versions)
...
- **Status**: [status.fanfare.io](https://status.fanfare.io)

## Feedback

Have feedback on recent changes or suggestions for new features?

- **Feature requests**: Submit via [dashboard](https://dashboard.fanfare.io/feedback)
- **Bug reports**: [Contact support](/resources/support/contact)
- **Community discussion**: [Developer forum](https://community.fanfare.io)
